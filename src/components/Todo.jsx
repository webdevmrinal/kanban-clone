...
export default function Todo({ tasks }) {
  return (
    <div className="bg-[#F5F5F5] px-2 mx-2 flex-1 rounded-2xl">
      <div className="flex items-center justify-between font-medium mx-4 py-4 border-b-4 border-[#5030E5]">
        <span>
          <span className="text-2xl pr-2 text-[#5030E5]">&bull;</span>
          <span>To Do</span>
          <div className="inline-block m-1 h-5 w-5 leading-5 text-xs text-center font-medium bg-[#E0E0E0] text-[#625F6D] rounded-full">
            {tasks.length.toString()}
          </div>
        </span>
        <img className="inline-block cursor-pointer" src={plusIcon} alt="" />
      </div>
