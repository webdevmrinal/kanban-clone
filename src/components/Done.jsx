...
export default function Done({ tasks }) {
  return (
    <div className="bg-[#F5F5F5] px-2 mx-2 flex-1 rounded-2xl">
      <div className="flex items-center justify-between font-medium mx-4 py-4 border-b-4 border-[#8BC48A]">
        <span>
          <span className="text-2xl pr-2 text-[#76A5EA]">&bull;</span>
          <span>Done</span>
                  ...
                  >
                    <div>
                      <div className="flex justify-between items-center">
                        <span
                          className={`font-medium text-xs px-2 py-1 rounded-md text-[#68B266] bg-[#83C29D33]`}
                        >
                          Completed
                        </span>
